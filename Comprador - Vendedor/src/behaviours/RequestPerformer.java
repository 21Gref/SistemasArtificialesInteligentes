...
public class RequestPerformer extends Behaviour {
    ...
    public RequestPerformer(BookBuyerAgent bookBuyerAgent) {
        ...
        bookTitle = bookBuyerAgent.getBookTitle();
    ...
    public void action() {
        switch (step) {
            ...
            case 1:
                ACLMessage reply = bookBuyerAgent.receive(messageTemplate);
                if (reply != null) {
