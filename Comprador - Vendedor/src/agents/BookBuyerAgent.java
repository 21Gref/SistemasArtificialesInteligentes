...
public class BookBuyerAgent extends Agent {
    ...
    private BookBuyerGui bookBuyerGui;
    
    protected void setup() {
        System.out.println("Buyer agent " + getAID().getName() + " is ready");

        bookBuyerGui = new BookBuyerGui(this);
        bookBuyerGui.setVisible(true);
    }
    
    public void buy(final String bookTitle) {
